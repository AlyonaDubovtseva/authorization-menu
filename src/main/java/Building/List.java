...
public class List implements Next, Previous{
    ...
    private Stage[] list = new Stage[]{new Project(Status.PLANNED), new Foundation(Status.PLANNED), new Walls(Status.PLANNED), new Roof(Status.PLANNED), new Completion(Status.PLANNED)};
    ...
    public void updateStatus() throws Deviation{
